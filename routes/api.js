        ...
        if (err) {
            ...
            const detailedConfigs = proxyConfigs.map(service => {
                ...
                return {
                    ...
                    stringToArray: service.stringToArray,
                    activeURL
                };
            });
...
router.post('/updateAPI', (req, res) => {
    ...
    const { service, proxyMode, proxyURL, stringToArrayDelimiter, stringToArrayEnable, stringToArraySingleRequests} = req.body;
    ...
    fs.readFile('./jsonfiles/proxy-configs.json', 'utf8', (err, data) => {
        ...
        serviceToUpdate.stringToArray.enable = stringToArrayEnable
        serviceToUpdate.stringToArray.delimiter = stringToArrayDelimiter
        serviceToUpdate.stringToArray.useSingleRequests = stringToArraySingleRequests
