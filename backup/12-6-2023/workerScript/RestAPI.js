...
const { GetDivertInfoForEquipment ,GetPLCIDForEquipment, PostSerialForReceiving, GetPLCTNUMForEquipment, GetPLCIDForTrackNum, SendToMQTT, DevicePakStation1, DevicePakStation2 } = require("../funtions/APIRequest");
